...
{"l":"cps/CpsAsyncMonad$.html","n":"Aux","t":"type Aux[F[_], C] = CpsAsyncMonad[F] { type Context = C;  }","d":"cps/CpsAsyncMonad$","k":"type"},
...
{"l":"cps/CpsConcurrentMonad$.html","n":"Aux","t":"type Aux[F[_], C] = CpsConcurrentMonad[F] { type Context = C;  }","d":"cps/CpsConcurrentMonad$","k":"type"},
...
{"l":"cps/CpsMonad$.html","n":"Aux","t":"type Aux[F[_], C] = CpsMonad[F] { type Context = C;  }","d":"cps/CpsMonad$","k":"type"},
...
{"l":"cps/CpsMonadContextProvider.html","n":"Context","t":"type Context","d":"cps/CpsMonadContextProvider","k":"type"},
...
{"l":"cps/CpsTryMonad$.html","n":"Aux","t":"type Aux[F[_], C] = CpsTryMonad[F] { type Context = C;  }","d":"cps/CpsTryMonad$","k":"type"},
...
{"l":"cps/macros/Async$.html","n":"nestTransform","t":"def nestTransform[F[_] : Type, T : Type, C : Type, S : Type](f: Expr[S], cpsCtx: TransformationContext[F, T, C])(implicit evidence$13: Type[F], evidence$14: Type[T], evidence$15: Type[C], evidence$16: Type[S], Quotes): CpsExpr[F, S]","d":"cps/macros/Async$","k":"def"},
...
{"l":"cps/macros/Async$.html","n":"rootTransform","t":"def rootTransform[F[_] : Type, T : Type, C : Type](f: Expr[T], dm: Expr[CpsMonad[F]], mc: Expr[C], optMemoization: Option[Memoization[F]], flags: AsyncMacroFlags, observatory: Observatory, nesting: Int, parent: Option[TransformationContext[_[_], _, _]])(implicit evidence$10: Type[F], evidence$11: Type[T], evidence$12: Type[C], Quotes): CpsExpr[F, T]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"transform","t":"def transform[F[_], T, C](inline expr: T, inline ctx: C)(using m: CpsMonad[F]): F[T]","d":"cps/macros/Async$","k":"def"},
...
{"l":"cps/macros/Async$.html","n":"transformContextLambda","t":"def transformContextLambda[F[_], T, C](inline expr: C => T)(using m: CpsMonad[F]): C => F[T]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"transformContextLambdaImpl","t":"def transformContextLambdaImpl[F[_] : Type, T : Type, C : Type](cexpr: Expr[C => T])(implicit evidence$17: Type[F], evidence$18: Type[T], evidence$19: Type[C], Quotes): Expr[C => F[T]]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"transformImpl","t":"def transformImpl[F[_] : Type, T : Type, C : Type](f: Expr[T], c: Expr[C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C], Quotes): Expr[F[T]]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"transformMonad","t":"def transformMonad[F[_] : Type, T : Type, C : Type](f: Expr[T], dm: Expr[CpsMonad[F]], mc: Expr[C])(implicit evidence$4: Type[F], evidence$5: Type[T], evidence$6: Type[C], Quotes): Expr[F[T]]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$$InferAsyncArg.html","n":"InferAsyncArg","t":"class InferAsyncArg[F[_], C](using val am: Aux[F, C])","d":"cps/macros/Async$$InferAsyncArg","k":"class"},
{"l":"cps/macros/Async$$InferAsyncArg.html","n":"am","t":"val am: Aux[F, C]","d":"cps/macros/Async$$InferAsyncArg","k":"val"},
...
{"l":"cps/macros/forest/ApplyTransform.html","n":"ApplyTransform","t":"class ApplyTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/ApplyTransform","k":"class"},
...
{"l":"cps/macros/forest/ApplyTreeTransform.html","n":"ApplyTreeTransform","t":"trait ApplyTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/ApplyTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/ApplyTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], applyTerm: Term, fun: Term, args: List[Term]): CpsExpr[F, T]","d":"cps/macros/forest/ApplyTreeTransform$","k":"def"},
{"l":"cps/macros/forest/AssignTransform.html","n":"AssignTransform","t":"class AssignTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/AssignTransform","k":"class"},
...
{"l":"cps/macros/forest/AsyncTreeShifter.html","n":"AsyncTreeShifter","t":"trait AsyncTreeShifter[F[_], CT, CC]","d":"cps/macros/forest/AsyncTreeShifter","k":"trait"},
...
{"l":"cps/macros/forest/AwaitTreeTransform.html","n":"AwaitTreeTransform","t":"trait AwaitTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/AwaitTreeTransform","k":"trait"},
{"l":"cps/macros/forest/AwaitTreeTransform.html","n":"adoptContextInMyAwait","t":"def adoptContextInMyAwait(awaitTerm: <none>, arg: <none>): <none>","d":"cps/macros/forest/AwaitTreeTransform","k":"def"},
{"l":"cps/macros/forest/AwaitTreeTransform.html","n":"findContextObject","t":"def findContextObject(): <none>","d":"cps/macros/forest/AwaitTreeTransform","k":"def"},
...
{"l":"cps/macros/forest/BlockTransform.html","n":"BlockTransform","t":"class BlockTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/BlockTransform","k":"class"},
...
{"l":"cps/macros/forest/ConstTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using Quotes)(cpsCtx: TransformationContext[F, T, C], constTerm: Literal): CpsExpr[F, T]","d":"cps/macros/forest/ConstTransform$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope.html","n":"CpsTreeScope","t":"trait CpsTreeScope[F[_], CT, CC]","d":"cps/macros/forest/CpsTreeScope","k":"trait"},
...
{"l":"cps/macros/forest/CpsTreeScope$AwaitAsyncCpsTree.html","n":"inCake","t":"def inCake[F1[_], T1, C1](otherCake: TreeTransformScope[F1, T1, C1]): CpsTree","d":"cps/macros/forest/CpsTreeScope$AwaitAsyncCpsTree","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$CpsTree.html","n":"inCake","t":"def inCake[F1[_], T1, C1](otherScope: TreeTransformScope[F1, T1, C1]): CpsTree","d":"cps/macros/forest/CpsTreeScope$CpsTree","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$SelectTypeApplyRecord.html","n":"inCake","t":"def inCake[F1[_], T1, C1](otherCake: TreeTransformScope[F1, T1, C1]): SelectTypeApplyRecord","d":"cps/macros/forest/CpsTreeScope$SelectTypeApplyRecord","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$ValCpsTree.html","n":"inCake","t":"def inCake[F1[_], T1, C1](otherScope: TreeTransformScope[F1, T1, C1]): ValCpsTree","d":"cps/macros/forest/CpsTreeScope$ValCpsTree","k":"def"},
...
{"l":"cps/macros/forest/IdentTransform.html","n":"IdentTransform","t":"class IdentTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/IdentTransform","k":"class"},
...
{"l":"cps/macros/forest/IfTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](cpsCtx: TransformationContext[F, T, C], cond: Expr[Boolean], ifTrue: Expr[T], ifFalse: Expr[T])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C], Quotes): CpsExpr[F, T]","d":"cps/macros/forest/IfTransform$","k":"def"},
...
{"l":"cps/macros/forest/ImportTransform$.html","n":"fromBlock","t":"def fromBlock[F[_] : Type, T : Type, C : Type](using Quotes)(cpsCtx: TransformationContext[F, T, C], importTree: Import): CpsExpr[F, Unit]","d":"cps/macros/forest/ImportTransform$","k":"def"},
{"l":"cps/macros/forest/InlinedTreeTransform.html","n":"InlinedTreeTransform","t":"trait InlinedTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/InlinedTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/InlinedTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], inlinedTerm: Inlined): CpsExpr[F, T]","d":"cps/macros/forest/InlinedTreeTransform$","k":"def"},
{"l":"cps/macros/forest/KnownTreeFragments.html","n":"KnownTreeFragments","t":"trait KnownTreeFragments[F[_], CT, CC]","d":"cps/macros/forest/KnownTreeFragments","k":"trait"},
...
{"l":"cps/macros/forest/LambdaTreeTransform.html","n":"LambdaTreeTransform","t":"trait LambdaTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/LambdaTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/LambdaTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], lambdaTerm: Term, params: List[ValDef], expr: Term): CpsExpr[F, T]","d":"cps/macros/forest/LambdaTreeTransform$","k":"def"},
{"l":"cps/macros/forest/MatchTreeTransform.html","n":"MatchTreeTransform","t":"trait MatchTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/MatchTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/MatchTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], matchTerm: Match): CpsExpr[F, T]","d":"cps/macros/forest/MatchTreeTransform$","k":"def"},
{"l":"cps/macros/forest/NewTransform.html","n":"NewTransform","t":"class NewTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/NewTransform","k":"class"},
...
{"l":"cps/macros/forest/RepeatedTransform.html","n":"RepeatedTransform","t":"class RepeatedTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/RepeatedTransform","k":"class"},
...
{"l":"cps/macros/forest/RepeatedTreeTransform.html","n":"RepeatedTreeTransform","t":"trait RepeatedTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/RepeatedTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/RepeatedTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], repeatedTerm: Term, elements: List[Term], tpt: TypeTree): CpsExpr[F, T]","d":"cps/macros/forest/RepeatedTreeTransform$","k":"def"},
{"l":"cps/macros/forest/ReturnTransform.html","n":"ReturnTransform","t":"class ReturnTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/ReturnTransform","k":"class"},
...
{"l":"cps/macros/forest/RootTreeTransform.html","n":"RootTreeTransform","t":"trait RootTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/RootTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/SelectOuterTreeTransform.html","n":"SelectOuterTreeTransform","t":"trait SelectOuterTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/SelectOuterTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/SelectOuterTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], selectOuterTerm: SelectOuter): CpsExpr[F, T]","d":"cps/macros/forest/SelectOuterTreeTransform$","k":"def"},
{"l":"cps/macros/forest/SelectTreeTransform.html","n":"SelectTreeTransform","t":"trait SelectTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/SelectTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/SelectTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], selectTerm: Select): CpsExpr[F, T]","d":"cps/macros/forest/SelectTreeTransform$","k":"def"},
{"l":"cps/macros/forest/SuperTransform.html","n":"SuperTransform","t":"class SuperTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/SuperTransform","k":"class"},
...
{"l":"cps/macros/forest/ThisTransform.html","n":"ThisTransform","t":"class ThisTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/ThisTransform","k":"class"},
...
{"l":"cps/macros/forest/ThrowTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type, S <: Throwable : Type](cpsCtx: TransformationContext[F, T, C], ex: Expr[S])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C], evidence$4: Type[S], Quotes): CpsExpr[F, T]","d":"cps/macros/forest/ThrowTransform$","k":"def"},
...
{"l":"cps/macros/forest/TreeTransformScope.html","n":"TreeTransformScope","t":"trait TreeTransformScope[F[_], CT, CC] extends CpsTreeScope[F, CT, CC] with KnownTreeFragments[F, CT, CC] with TypeApplyTreeTransform[F, CT, CC] with RootTreeTransform[F, CT, CC] with ApplyTreeTransform[F, CT, CC] with ApplicationHelper[F, CT, CC] with AwaitTreeTransform[F, CT, CC] with SelectTreeTransform[F, CT, CC] with LambdaTreeTransform[F, CT, CC] with MatchTreeTransform[F, CT, CC] with AsyncTreeShifter[F, CT, CC] with RepeatedTreeTransform[F, CT, CC] with InlinedTreeTransform[F, CT, CC] with SelectOuterTreeTransform[F, CT, CC]","d":"cps/macros/forest/TreeTransformScope","k":"trait"},
...
{"l":"cps/macros/forest/TryTransform.html","n":"TryTransform","t":"class TryTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/TryTransform","k":"class"},
...
{"l":"cps/macros/forest/TypeApplyTransform.html","n":"TypeApplyTransform","t":"class TypeApplyTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/TypeApplyTransform","k":"class"},
...
{"l":"cps/macros/forest/TypeApplyTreeTransform.html","n":"TypeApplyTreeTransform","t":"trait TypeApplyTreeTransform[F[_], CT, CC]","d":"cps/macros/forest/TypeApplyTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/TypeApplyTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T, C], applyTerm: Term, fun: Term, targs: List[TypeTree]): CpsExpr[F, T]","d":"cps/macros/forest/TypeApplyTreeTransform$","k":"def"},
{"l":"cps/macros/forest/TypedTransform.html","n":"TypedTransform","t":"class TypedTransform[F[_], T, C](cpsCtx: TransformationContext[F, T, C])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C])","d":"cps/macros/forest/TypedTransform","k":"class"},
...
{"l":"cps/macros/forest/ValDefTransform$.html","n":"fromBlock","t":"def fromBlock[F[_] : Type, C : Type](using Quotes)(cpsCtx: TransformationContext[F, Unit, C], valDef: ValDef): CpsExpr[F, Unit]","d":"cps/macros/forest/ValDefTransform$","k":"def"},
...
{"l":"cps/macros/forest/WhileTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, C : Type](cpsCtx: TransformationContext[F, T, C], cond: Expr[Boolean], repeat: Expr[Unit])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[C], Quotes): CpsExpr[F, T]","d":"cps/macros/forest/WhileTransform$","k":"def"},
...
{"l":"cps/macros/forest/application/ApplicationHelper.html","n":"ApplicationHelper","t":"trait ApplicationHelper[F[_], CT, CC] extends ApplyArgRecordScope[F, CT, CC] with MethodParamsDescriptorScope[F, CT, CC] with ApplyArgBuilderScope[F, CT, CC]","d":"cps/macros/forest/application/ApplicationHelper","k":"trait"},
{"l":"cps/macros/forest/application/ApplyArgBuilderScope.html","n":"ApplyArgBuilderScope","t":"trait ApplyArgBuilderScope[F[_], CT, CC]","d":"cps/macros/forest/application/ApplyArgBuilderScope","k":"trait"},
...
{"l":"cps/macros/forest/application/ApplyArgRecordScope.html","n":"ApplyArgRecordScope","t":"trait ApplyArgRecordScope[F[_], CT, CC]","d":"cps/macros/forest/application/ApplyArgRecordScope","k":"trait"},
...
{"l":"cps/macros/forest/application/MethodParamsDescriptorScope.html","n":"MethodParamsDescriptorScope","t":"trait MethodParamsDescriptorScope[F[_], CT, CC]","d":"cps/macros/forest/application/MethodParamsDescriptorScope","k":"trait"},
...
{"l":"cps/monads.html","n":"FutureAsyncMonad","t":"given FutureAsyncMonad: CpsSchedulingMonad[Future]","d":"cps/monads","k":"given"},
{"l":"cps/monads/fromFutureConversion.html","n":"fromFutureConversion","t":"given fromFutureConversion[G[_], T](using val ex: ExecutionContext, val m: CpsAsyncMonad[G]): CpsMonadConversion[Future, G]","d":"cps/monads","k":"given"},
{"l":"cps/monads/fromFutureConversion.html","n":"apply","t":"def apply[T](ft: Future[T]): G[T]","d":"cps/monads","k":"def"},
{"l":"cps/monads/fromFutureConversion.html","n":"ex","t":"val ex: ExecutionContext","d":"cps/monads","k":"val"},
{"l":"cps/monads/fromFutureConversion.html","n":"m","t":"val m: CpsAsyncMonad[G]","d":"cps/monads","k":"val"},
...
{"l":"cps/monads/fromFutureConversion.html","n":"fromFutureConversion","t":"given fromFutureConversion[G[_], T](using val ex: ExecutionContext, val m: CpsAsyncMonad[G]): CpsMonadConversion[Future, G]","d":"cps/monads/fromFutureConversion","k":"given"},
{"l":"cps/monads/fromFutureConversion.html","n":"apply","t":"def apply[T](ft: Future[T]): G[T]","d":"cps/monads/fromFutureConversion","k":"def"},
{"l":"cps/monads/fromFutureConversion.html","n":"ex","t":"val ex: ExecutionContext","d":"cps/monads/fromFutureConversion","k":"val"},
{"l":"cps/monads/fromFutureConversion.html","n":"m","t":"val m: CpsAsyncMonad[G]","d":"cps/monads/fromFutureConversion","k":"val"},
...
{"l":"cps/monads/jsfuture/JSFuture$.html","n":"JSFuture","t":"object JSFuture","d":"cps/monads/jsfuture/JSFuture$","k":"object"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"JSFutureCpsMonad","t":"given JSFutureCpsMonad: CpsTryMonad[JSFuture]","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"error","t":"def error[A](ex: Throwable): JSFuture[A]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"flatMap","t":"def flatMap[A, B](fa: JSFuture[A])(f: A => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"flatMapTry","t":"def flatMapTry[A, B](fa: JSFuture[A])(f: Try[A] => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"map","t":"def map[A, B](fa: JSFuture[A])(f: A => B): JSFuture[B]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"pure","t":"def pure[A](a: A): JSFuture[A]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$.html","n":"given_CpsMonadConversion_Future_JSFuture","t":"given given_CpsMonadConversion_Future_JSFuture: CpsMonadConversion[Future, JSFuture]","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$.html","n":"apply","t":"def apply[T](ft: Future[T]): JSFuture[T]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$.html","n":"given_CpsMonadConversion_JSFuture_Future","t":"given given_CpsMonadConversion_JSFuture_Future: CpsMonadConversion[JSFuture, Future]","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$.html","n":"apply","t":"def apply[T](ft: JSFuture[T]): Future[T]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$.html","n":"given_CpsMonadConversion_Promise_JSFuture","t":"given given_CpsMonadConversion_Promise_JSFuture: CpsMonadConversion[Promise, JSFuture]","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$.html","n":"apply","t":"def apply[T](ft: Promise[T]): JSFuture[T]","d":"cps/monads/jsfuture/JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"JSFutureCpsMonad","t":"given JSFutureCpsMonad: CpsTryMonad[JSFuture]","d":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"error","t":"def error[A](ex: Throwable): JSFuture[A]","d":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"flatMap","t":"def flatMap[A, B](fa: JSFuture[A])(f: A => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"flatMapTry","t":"def flatMapTry[A, B](fa: JSFuture[A])(f: Try[A] => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"map","t":"def map[A, B](fa: JSFuture[A])(f: A => B): JSFuture[B]","d":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"pure","t":"def pure[A](a: A): JSFuture[A]","d":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$.html","n":"given_CpsMonadConversion_Future_JSFuture","t":"given given_CpsMonadConversion_Future_JSFuture: CpsMonadConversion[Future, JSFuture]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$.html","n":"apply","t":"def apply[T](ft: Future[T]): JSFuture[T]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$.html","n":"given_CpsMonadConversion_JSFuture_Future","t":"given given_CpsMonadConversion_JSFuture_Future: CpsMonadConversion[JSFuture, Future]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$.html","n":"apply","t":"def apply[T](ft: JSFuture[T]): Future[T]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$.html","n":"given_CpsMonadConversion_Promise_JSFuture","t":"given given_CpsMonadConversion_Promise_JSFuture: CpsMonadConversion[Promise, JSFuture]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$.html","n":"apply","t":"def apply[T](ft: Promise[T]): JSFuture[T]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$","k":"def"},
...
{"l":"cps/stream/AsyncIteratorEmitAbsorber.html","n":"AsyncIteratorEmitAbsorber","t":"class AsyncIteratorEmitAbsorber[F[_], C, T](using ec: ExecutionContext, auxAsyncMonad: Aux[F, C]) extends CpsAsyncEmitAbsorber4[AsyncIterator[F, T], F, C, T]","d":"cps/stream/AsyncIteratorEmitAbsorber","k":"class"},
...
{"l":"cps/stream/AsyncListEmitAbsorber.html","n":"AsyncListEmitAbsorber","t":"class AsyncListEmitAbsorber[F[_], C, T](using ec: ExecutionContext, auxMonad: Aux[F, C]) extends BaseUnfoldCpsAsyncEmitAbsorber[AsyncList[F, T], F, C, T]","d":"cps/stream/AsyncListEmitAbsorber","k":"class"},
...
{"l":"cps/stream/AsyncStreamHelper.html","n":"AsyncStreamHelper","t":"class AsyncStreamHelper[R, F[_], C, A](a: Aux[R, F, C, A])","d":"cps/stream/AsyncStreamHelper","k":"class"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"BaseUnfoldCpsAsyncEmitAbsorber","t":"trait BaseUnfoldCpsAsyncEmitAbsorber[R, F[_], C, T](using ec: ExecutionContext, auxAsyncMonad: Aux[F, C]) extends CpsAsyncEmitAbsorber4[R, F, C, T]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"trait"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"asyncMonad","t":"val asyncMonad: Aux[F, C]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"val"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"evalAsyncInContext","t":"def evalAsyncInContext(f: CpsAsyncEmitter[F, T] => F[Unit]): R","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"def"},
...
{"l":"cps/stream/CpsAsyncEmitAbsorber.html","n":"Context","t":"type Context","d":"cps/stream/CpsAsyncEmitAbsorber","k":"type"},
...
{"l":"cps/stream/CpsAsyncEmitAbsorber$.html","n":"Aux","t":"type Aux[R, F[_], C, T] = CpsAsyncEmitAbsorber[R] { type Monad = F; type Context = C; type Element = T;  }","d":"cps/stream/CpsAsyncEmitAbsorber$","k":"type"},
{"l":"cps/stream/CpsAsyncEmitAbsorber4.html","n":"CpsAsyncEmitAbsorber4","t":"trait CpsAsyncEmitAbsorber4[R, F[_], C, T](using val auxAsyncMonad: Aux[F, C]) extends CpsAsyncEmitAbsorber[R]","d":"cps/stream/CpsAsyncEmitAbsorber4","k":"trait"},
...
{"l":"cps/stream/CpsAsyncEmitAbsorber4.html","n":"auxAsyncMonad","t":"val auxAsyncMonad: Aux[F, C]","d":"cps/stream/CpsAsyncEmitAbsorber4","k":"val"},
...
{"l":"cps/stream/CpsAsyncStreamMacro$.html","n":"transform","t":"def transform[R : Type, F[_] : Type, C : Type, T : Type](f: Expr[C => CpsAsyncEmitter[F, T] => Unit], absorber: Expr[Aux[R, F, C, T]])(implicit evidence$2: Type[R], evidence$3: Type[F], evidence$4: Type[C], evidence$5: Type[T], Quotes): Expr[R]","d":"cps/stream/CpsAsyncStreamMacro$","k":"def"},
{"l":"cps/stream/CpsAsyncStreamMacro$.html","n":"transformTree","t":"def transformTree[R : Type, F[_] : Type, C : Type, T : Type](using qctx: Quotes)(f: Term, absorber: Expr[Aux[R, F, C, T]]): Term","d":"cps/stream/CpsAsyncStreamMacro$","k":"def"},
