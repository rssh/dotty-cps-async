...
{"l":"cps.html","n":"async","t":"def async[F[_]](using inline am: CpsMonad[F]): InferAsyncArg[F]","d":"cps","k":"def"},
{"l":"cps.html","n":"asyncStream","t":"def asyncStream[R](using a: CpsAsyncEmitAbsorber[R]): AsyncStreamHelper[R, Monad, Element]","d":"cps","k":"def"},
{"l":"cps.html","n":"await","t":"def await[F[_], T](f: F[T])(using am: CpsAwaitable[F]): T","d":"cps","k":"def"},
{"l":"cps/customValueDiscard$.html","n":"customValueDiscard","t":"given customValueDiscard: CustomTag","d":"cps","k":"given"},
{"l":"cps/warnValueDiscard$.html","n":"warnValueDiscard","t":"given warnValueDiscard: WarnTag","d":"cps","k":"given"},
...
{"l":"cps/AsyncShift$.html","n":"shiftedArrayOps","t":"given shiftedArrayOps","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedCpsMonad","t":"given shiftedCpsMonad","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedEither","t":"given shiftedEither","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedEitherLeftProjection","t":"given shiftedEitherLeftProjection","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedFunction1","t":"given shiftedFunction1","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedImmutableMapOps","t":"given shiftedImmutableMapOps","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedIndexedSeqOps","t":"given shiftedIndexedSeqOps","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedIterable","t":"given shiftedIterable","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedIterableOps","t":"given shiftedIterableOps","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedList","t":"given shiftedList","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedMapOps","t":"given shiftedMapOps","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedOption","t":"given shiftedOption","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedPartialFunction","t":"given shiftedPartialFunction","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedRange","t":"given shiftedRange","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedSeqOps","t":"given shiftedSeqOps","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedTry","t":"given shiftedTry","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedTryModule","t":"given shiftedTryModule","d":"cps/AsyncShift$","k":"given"},
{"l":"cps/AsyncShift$.html","n":"shiftedUsing","t":"given shiftedUsing","d":"cps/AsyncShift$","k":"given"},
...
{"l":"cps/ValueDiscard$.html","n":"booleanValueDiscard","t":"given booleanValueDiscard","d":"cps/ValueDiscard$","k":"given"},
{"l":"cps/ValueDiscard$.html","n":"intValueDiscard","t":"given intValueDiscard","d":"cps/ValueDiscard$","k":"given"},
{"l":"cps/ValueDiscard$.html","n":"longValueDiscard","t":"given longValueDiscard","d":"cps/ValueDiscard$","k":"given"},
{"l":"cps/ValueDiscard$.html","n":"stringValueDiscard","t":"given stringValueDiscard","d":"cps/ValueDiscard$","k":"given"},
...
{"l":"cps/customValueDiscard$.html","n":"customValueDiscard","t":"given customValueDiscard: CustomTag","d":"cps/customValueDiscard$","k":"given"},
{"l":"cps/warnValueDiscard$.html","n":"warnValueDiscard","t":"given warnValueDiscard: WarnTag","d":"cps/warnValueDiscard$","k":"given"},
{"l":"cps/automaticColoring.html","n":"cps.automaticColoring","t":"package cps.automaticColoring","d":"cps/automaticColoring","k":"package"},
{"l":"cps/automaticColoring.html","n":"conversion","t":"given conversion: T => U","d":"cps/automaticColoring","k":"given"},
{"l":"cps/automaticColoring/tag.html","n":"tag","t":"given tag[F[_]]: AutomaticColoringTag[F]","d":"cps/automaticColoring","k":"given"},
...
{"l":"cps/automaticColoring/tag.html","n":"tag","t":"given tag[F[_]]: AutomaticColoringTag[F]","d":"cps/automaticColoring/tag","k":"given"},
{"l":"cps/compat.html","n":"cps.compat","t":"package cps.compat","d":"cps/compat","k":"package"},
{"l":"cps/compat.html","n":"sip22","t":"val sip22: FutureAsync","d":"cps/compat","k":"val"},
...
{"l":"cps/macros/given_FromExpr_AsyncMacroFlags$.html","n":"given_FromExpr_AsyncMacroFlags","t":"given given_FromExpr_AsyncMacroFlags: FromExpr[AsyncMacroFlags]","d":"cps/macros","k":"given"},
{"l":"cps/macros/given_FromExpr_AsyncMacroFlags$.html","n":"unapply","t":"def unapply(v: Expr[AsyncMacroFlags])(using Quotes): Option[AsyncMacroFlags]","d":"cps/macros","k":"def"},
{"l":"cps/macros/Async$.html","n":"Async","t":"object Async","d":"cps/macros/Async$","k":"object"},
{"l":"cps/macros/Async$.html","n":"adoptFlags","t":"def adoptFlags[F[_] : Type, T](f: Expr[T], dm: Expr[CpsMonad[F]])(implicit evidence$5: Type[F], Quotes): AsyncMacroFlags","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"async","t":"def async[F[_]](using am: CpsMonad[F]): InferAsyncArg[F]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"nestTransform","t":"def nestTransform[F[_] : Type, T : Type, S : Type](f: Expr[S], cpsCtx: TransformationContext[F, T])(implicit evidence$10: Type[F], evidence$11: Type[T], evidence$12: Type[S], Quotes): CpsExpr[F, S]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"resolveMemoization","t":"def resolveMemoization[F[_] : Type, T : Type](f: Expr[T], dm: Expr[CpsMonad[F]])(implicit evidence$6: Type[F], evidence$7: Type[T], Quotes): Memoization[F]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"rootTransform","t":"def rootTransform[F[_] : Type, T : Type](f: Expr[T], dm: Expr[CpsMonad[F]], optMemoization: Option[Memoization[F]], flags: AsyncMacroFlags, observatory: Observatory, nesting: Int, parent: Option[TransformationContext[_[_], _]])(implicit evidence$8: Type[F], evidence$9: Type[T], Quotes): CpsExpr[F, T]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"transform","t":"def transform[F[_], T](inline expr: T)(using m: CpsMonad[F]): F[T]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"transformImpl","t":"def transformImpl[F[_] : Type, T : Type](f: Expr[T])(implicit evidence$1: Type[F], evidence$2: Type[T], Quotes): Expr[F[T]]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$.html","n":"transformMonad","t":"def transformMonad[F[_] : Type, T : Type](f: Expr[T], dm: Expr[CpsMonad[F]])(implicit evidence$3: Type[F], evidence$4: Type[T], Quotes): Expr[F[T]]","d":"cps/macros/Async$","k":"def"},
{"l":"cps/macros/Async$$InferAsyncArg.html","n":"InferAsyncArg","t":"class InferAsyncArg[F[_]](using am: CpsMonad[F])","d":"cps/macros/Async$$InferAsyncArg","k":"class"},
{"l":"cps/macros/Async$$InferAsyncArg.html","n":"apply","t":"def apply[T](inline expr: T): F[T]","d":"cps/macros/Async$$InferAsyncArg","k":"def"},
...
{"l":"cps/macros/TransformationContext.html","n":"TransformationContext","t":"class TransformationContext[F[_], T](patternCode: Expr[T], patternType: Type[T], monad: Expr[CpsMonad[F]], memoization: Option[Memoization[F]], flags: AsyncMacroFlags, observatory: Observatory, nesting: Int, parent: Option[TransformationContext[_[_], _]])","d":"cps/macros/TransformationContext","k":"class"},
{"l":"cps/macros/TransformationContext.html","n":"log","t":"def log(message: String): Unit","d":"cps/macros/TransformationContext","k":"def"},
{"l":"cps/macros/TransformationContext.html","n":"nest","t":"def nest[S](newPatternCode: Expr[S], newPatternType: Type[S], muted: Boolean): TransformationContext[F, S]","d":"cps/macros/TransformationContext","k":"def"},
{"l":"cps/macros/TransformationContext.html","n":"nestSame","t":"def nestSame(muted: Boolean): TransformationContext[F, T]","d":"cps/macros/TransformationContext","k":"def"},
...
{"l":"cps/macros/given_FromExpr_AsyncMacroFlags$.html","n":"given_FromExpr_AsyncMacroFlags","t":"given given_FromExpr_AsyncMacroFlags: FromExpr[AsyncMacroFlags]","d":"cps/macros/given_FromExpr_AsyncMacroFlags$","k":"given"},
...
{"l":"cps/macros/flags/given_FromExpr_DebugLevel$.html","n":"given_FromExpr_DebugLevel","t":"given given_FromExpr_DebugLevel: FromExpr[DebugLevel]","d":"cps/macros/flags","k":"given"},
{"l":"cps/macros/flags/given_FromExpr_DebugLevel$.html","n":"unapply","t":"def unapply(x: Expr[DebugLevel])(using Quotes): Option[DebugLevel]","d":"cps/macros/flags","k":"def"},
...
{"l":"cps/macros/flags/given_FromExpr_DebugLevel$.html","n":"given_FromExpr_DebugLevel","t":"given given_FromExpr_DebugLevel: FromExpr[DebugLevel]","d":"cps/macros/flags/given_FromExpr_DebugLevel$","k":"given"},
...
{"l":"cps/macros/forest/ApplyTransform.html","n":"ApplyTransform","t":"class ApplyTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/ApplyTransform","k":"class"},
...
{"l":"cps/macros/forest/ApplyTreeTransform.html","n":"ApplyTreeTransform","t":"trait ApplyTreeTransform[F[_], CT]","d":"cps/macros/forest/ApplyTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/ApplyTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], applyTerm: Term, fun: Term, args: List[Term]): CpsExpr[F, T]","d":"cps/macros/forest/ApplyTreeTransform$","k":"def"},
{"l":"cps/macros/forest/AssignTransform.html","n":"AssignTransform","t":"class AssignTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/AssignTransform","k":"class"},
...
{"l":"cps/macros/forest/AsyncTreeShifter.html","n":"AsyncTreeShifter","t":"trait AsyncTreeShifter[F[_], CT]","d":"cps/macros/forest/AsyncTreeShifter","k":"trait"},
...
{"l":"cps/macros/forest/AwaitTreeTransform.html","n":"AwaitTreeTransform","t":"trait AwaitTreeTransform[F[_], CT]","d":"cps/macros/forest/AwaitTreeTransform","k":"trait"},
{"l":"cps/macros/forest/AwaitTreeTransform.html","n":"runAwait","t":"def runAwait(term: <none>, arg: <none>, awaitCpsMonadType: <none>, awaitCpsMonad: <none>): <none>","d":"cps/macros/forest/AwaitTreeTransform","k":"def"},
{"l":"cps/macros/forest/AwaitTreeTransform.html","n":"runMyAwait","t":"def runMyAwait(awaitTerm: <none>, arg: <none>): <none>","d":"cps/macros/forest/AwaitTreeTransform","k":"def"},
{"l":"cps/macros/forest/AwaitTreeTransform.html","n":"runOtherAwait","t":"def runOtherAwait(awaitTerm: <none>, arg: <none>, targ: <none>, otherCpsMonad: <none>): <none>","d":"cps/macros/forest/AwaitTreeTransform","k":"def"},
{"l":"cps/macros/forest/BlockTransform.html","n":"BlockTransform","t":"class BlockTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/BlockTransform","k":"class"},
...
{"l":"cps/macros/forest/ConstTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using Quotes)(cpsCtx: TransformationContext[F, T], constTerm: Literal): CpsExpr[F, T]","d":"cps/macros/forest/ConstTransform$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope.html","n":"CpsTreeScope","t":"trait CpsTreeScope[F[_], CT]","d":"cps/macros/forest/CpsTreeScope","k":"trait"},
...
{"l":"cps/macros/forest/CpsTreeScope$AwaitAsyncCpsTree.html","n":"inCake","t":"def inCake[F1[_], T1](otherCake: TreeTransformScope[F1, T1]): CpsTree","d":"cps/macros/forest/CpsTreeScope$AwaitAsyncCpsTree","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$CpsTree.html","n":"inCake","t":"def inCake[F1[_], T1](otherScope: TreeTransformScope[F1, T1]): CpsTree","d":"cps/macros/forest/CpsTreeScope$CpsTree","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$SelectTypeApplyRecord.html","n":"inCake","t":"def inCake[F1[_], T1](otherCake: TreeTransformScope[F1, T1]): SelectTypeApplyRecord","d":"cps/macros/forest/CpsTreeScope$SelectTypeApplyRecord","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$ValCpsTree.html","n":"inCake","t":"def inCake[F1[_], T1](otherScope: TreeTransformScope[F1, T1]): ValCpsTree","d":"cps/macros/forest/CpsTreeScope$ValCpsTree","k":"def"},
{"l":"cps/macros/forest/DefCpsExpr.html","n":"DefCpsExpr","t":"class DefCpsExpr[F[_]](using qctx: Quotes)(monad: Expr[CpsMonad[F]], prev: Seq[ExprTreeGen], definition: Definition, changed: Boolean)(implicit evidence$3: Type[F]) extends SyncCpsExpr[F, Unit]","d":"cps/macros/forest/DefCpsExpr","k":"class"},
{"l":"cps/macros/forest/DefCpsExpr.html","n":"append","t":"def append[A : Type](chunk: CpsExpr[F, A])(implicit evidence$4: Type[A], Quotes): CpsExpr[F, A]","d":"cps/macros/forest/DefCpsExpr","k":"def"},
...
{"l":"cps/macros/forest/IdentTransform.html","n":"IdentTransform","t":"class IdentTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/IdentTransform","k":"class"},
...
{"l":"cps/macros/forest/IfTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](cpsCtx: TransformationContext[F, T], cond: Expr[Boolean], ifTrue: Expr[T], ifFalse: Expr[T])(implicit evidence$1: Type[F], evidence$2: Type[T], Quotes): CpsExpr[F, T]","d":"cps/macros/forest/IfTransform$","k":"def"},
...
{"l":"cps/macros/forest/ImportTransform$.html","n":"fromBlock","t":"def fromBlock[F[_] : Type, T : Type](using Quotes)(cpsCtx: TransformationContext[F, T], importTree: Import): CpsExpr[F, Unit]","d":"cps/macros/forest/ImportTransform$","k":"def"},
{"l":"cps/macros/forest/InlinedTreeTransform.html","n":"InlinedTreeTransform","t":"trait InlinedTreeTransform[F[_], CT]","d":"cps/macros/forest/InlinedTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/InlinedTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], inlinedTerm: Inlined): CpsExpr[F, T]","d":"cps/macros/forest/InlinedTreeTransform$","k":"def"},
{"l":"cps/macros/forest/KnownTreeFragments.html","n":"KnownTreeFragments","t":"trait KnownTreeFragments[F[_], CT]","d":"cps/macros/forest/KnownTreeFragments","k":"trait"},
...
{"l":"cps/macros/forest/LambdaTreeTransform.html","n":"LambdaTreeTransform","t":"trait LambdaTreeTransform[F[_], CT]","d":"cps/macros/forest/LambdaTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/LambdaTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], lambdaTerm: Term, params: List[ValDef], expr: Term): CpsExpr[F, T]","d":"cps/macros/forest/LambdaTreeTransform$","k":"def"},
{"l":"cps/macros/forest/MatchTreeTransform.html","n":"MatchTreeTransform","t":"trait MatchTreeTransform[F[_], CT]","d":"cps/macros/forest/MatchTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/MatchTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], matchTerm: Match): CpsExpr[F, T]","d":"cps/macros/forest/MatchTreeTransform$","k":"def"},
{"l":"cps/macros/forest/NewTransform.html","n":"NewTransform","t":"class NewTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/NewTransform","k":"class"},
...
{"l":"cps/macros/forest/RepeatedTransform.html","n":"RepeatedTransform","t":"class RepeatedTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/RepeatedTransform","k":"class"},
...
{"l":"cps/macros/forest/RepeatedTreeTransform.html","n":"RepeatedTreeTransform","t":"trait RepeatedTreeTransform[F[_], CT]","d":"cps/macros/forest/RepeatedTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/RepeatedTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], repeatedTerm: Term, elements: List[Term], tpt: TypeTree): CpsExpr[F, T]","d":"cps/macros/forest/RepeatedTreeTransform$","k":"def"},
{"l":"cps/macros/forest/ReturnTransform.html","n":"ReturnTransform","t":"class ReturnTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/ReturnTransform","k":"class"},
...
{"l":"cps/macros/forest/RootTreeTransform.html","n":"RootTreeTransform","t":"trait RootTreeTransform[F[_], CT]","d":"cps/macros/forest/RootTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/RootTreeTransform$B2$.html","n":"inNestedContext","t":"def inNestedContext(term: Term, muted: Boolean, op: TreeTransformScope[F, _] => CpsTree): CpsTree","d":"cps/macros/forest/RootTreeTransform$B2$","k":"def"},
{"l":"cps/macros/forest/RootTreeTransform$B2$.html","n":"nestScope","t":"def nestScope[E : Type](e: Expr[E], muted: Boolean): TreeTransformScope[F, E]","d":"cps/macros/forest/RootTreeTransform$B2$","k":"def"},
{"l":"cps/macros/forest/SelectOuterTreeTransform.html","n":"SelectOuterTreeTransform","t":"trait SelectOuterTreeTransform[F[_], CT]","d":"cps/macros/forest/SelectOuterTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/SelectOuterTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], selectOuterTerm: SelectOuter): CpsExpr[F, T]","d":"cps/macros/forest/SelectOuterTreeTransform$","k":"def"},
{"l":"cps/macros/forest/SelectTreeTransform.html","n":"SelectTreeTransform","t":"trait SelectTreeTransform[F[_], CT]","d":"cps/macros/forest/SelectTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/SelectTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], selectTerm: Select): CpsExpr[F, T]","d":"cps/macros/forest/SelectTreeTransform$","k":"def"},
{"l":"cps/macros/forest/SuperTransform.html","n":"SuperTransform","t":"class SuperTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/SuperTransform","k":"class"},
...
{"l":"cps/macros/forest/ThisTransform.html","n":"ThisTransform","t":"class ThisTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/ThisTransform","k":"class"},
...
{"l":"cps/macros/forest/ThrowTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type, S <: Throwable : Type](cpsCtx: TransformationContext[F, T], ex: Expr[S])(implicit evidence$1: Type[F], evidence$2: Type[T], evidence$3: Type[S], Quotes): CpsExpr[F, T]","d":"cps/macros/forest/ThrowTransform$","k":"def"},
...
{"l":"cps/macros/forest/TransformUtil$.html","n":"find","t":"def find(using Quotes)(term: Term, cond: Tree => Option[Tree]): Option[Tree]","d":"cps/macros/forest/TransformUtil$","k":"def"},
...
{"l":"cps/macros/forest/TreeTransformScope.html","n":"cpsCtx","t":"val cpsCtx: TransformationContext[F, CT]","d":"cps/macros/forest/TreeTransformScope","k":"val"},
...
{"l":"cps/macros/forest/TreeTransformScopeInstance.html","n":"cpsCtx","t":"val cpsCtx: TransformationContext[F, T]","d":"cps/macros/forest/TreeTransformScopeInstance","k":"val"},
...
{"l":"cps/macros/forest/TryTransform.html","n":"TryTransform","t":"class TryTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/TryTransform","k":"class"},
...
{"l":"cps/macros/forest/TypeApplyTransform.html","n":"TypeApplyTransform","t":"class TypeApplyTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/TypeApplyTransform","k":"class"},
...
{"l":"cps/macros/forest/TypeApplyTreeTransform.html","n":"TypeApplyTreeTransform","t":"trait TypeApplyTreeTransform[F[_], CT]","d":"cps/macros/forest/TypeApplyTreeTransform","k":"trait"},
...
{"l":"cps/macros/forest/TypeApplyTreeTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](using qctx1: Quotes)(cpsCtx1: TransformationContext[F, T], applyTerm: Term, fun: Term, targs: List[TypeTree]): CpsExpr[F, T]","d":"cps/macros/forest/TypeApplyTreeTransform$","k":"def"},
{"l":"cps/macros/forest/TypedTransform.html","n":"TypedTransform","t":"class TypedTransform[F[_], T](cpsCtx: TransformationContext[F, T])(implicit evidence$1: Type[F], evidence$2: Type[T])","d":"cps/macros/forest/TypedTransform","k":"class"},
...
{"l":"cps/macros/forest/ValDefTransform$.html","n":"fromBlock","t":"def fromBlock[F[_] : Type](using Quotes)(cpsCtx: TransformationContext[F, Unit], valDef: ValDef): CpsExpr[F, Unit]","d":"cps/macros/forest/ValDefTransform$","k":"def"},
...
{"l":"cps/macros/forest/WhileTransform$.html","n":"run","t":"def run[F[_] : Type, T : Type](cpsCtx: TransformationContext[F, T], cond: Expr[Boolean], repeat: Expr[Unit])(implicit evidence$1: Type[F], evidence$2: Type[T], Quotes): CpsExpr[F, T]","d":"cps/macros/forest/WhileTransform$","k":"def"},
...
{"l":"cps/macros/forest/application/ApplicationHelper.html","n":"ApplicationHelper","t":"trait ApplicationHelper[F[_], CT] extends ApplyArgRecordScope[F, CT] with MethodParamsDescriptorScope[F, CT] with ApplyArgBuilderScope[F, CT]","d":"cps/macros/forest/application/ApplicationHelper","k":"trait"},
{"l":"cps/macros/forest/application/ApplyArgBuilderScope.html","n":"ApplyArgBuilderScope","t":"trait ApplyArgBuilderScope[F[_], CT]","d":"cps/macros/forest/application/ApplyArgBuilderScope","k":"trait"},
...
{"l":"cps/macros/forest/application/ApplyArgBuilderScope$O$.html","n":"buildApplyArgRecord","t":"def buildApplyArgRecord(paramsDescriptor: MethodParamsDescriptor, t: Term, cpsCtx: TransformationContext[F, _], acc: BuildApplyArgsAcc): BuildApplyArgsAcc","d":"cps/macros/forest/application/ApplyArgBuilderScope$O$","k":"def"},
{"l":"cps/macros/forest/application/ApplyArgBuilderScope$O$.html","n":"buildApplyArgsRecords","t":"def buildApplyArgsRecords(paramsDescriptor: MethodParamsDescriptor, args: List[Term], cpsCtx: TransformationContext[F, _]): List[ApplyArgRecord]","d":"cps/macros/forest/application/ApplyArgBuilderScope$O$","k":"def"},
...
{"l":"cps/macros/forest/application/ApplyArgRecordScope.html","n":"ApplyArgRecordScope","t":"trait ApplyArgRecordScope[F[_], CT]","d":"cps/macros/forest/application/ApplyArgRecordScope","k":"trait"},
...
{"l":"cps/macros/forest/application/MethodParamsDescriptorScope.html","n":"MethodParamsDescriptorScope","t":"trait MethodParamsDescriptorScope[F[_], CT]","d":"cps/macros/forest/application/MethodParamsDescriptorScope","k":"trait"},
...
{"l":"cps/macros/observatory/ObservatoryQuoteScope.html","n":"Quotes","t":"val Quotes: Quotes","d":"cps/macros/observatory/ObservatoryQuoteScope","k":"val"},
...
{"l":"cps/monads.html","n":"CpsMonadMemoization_Promise","t":"val CpsMonadMemoization_Promise: CpsMonadMemoization[Promise]","d":"cps/monads","k":"val"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"FutureAsyncMonad","t":"given FutureAsyncMonad(using val x$1: ExecutionContext): CpsSchedulingMonad[Future]","d":"cps/monads","k":"given"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"F","t":"type F[+T] = Future[T]","d":"cps/monads","k":"type"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"WF","t":"type WF[T] = Future[T]","d":"cps/monads","k":"type"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"adoptCallbackStyle","t":"def adoptCallbackStyle[A](source: Try[A] => Unit => Unit): Future[A]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"error","t":"def error[A](e: Throwable): Future[A]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"executionContext","t":"def executionContext: ExecutionContext","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"flatMap","t":"def flatMap[A, B](fa: Future[A])(f: A => Future[B]): Future[B]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"flatMapTry","t":"def flatMapTry[A, B](fa: Future[A])(f: Try[A] => Future[B]): Future[B]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"map","t":"def map[A, B](fa: Future[A])(f: A => B): Future[B]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"pure","t":"def pure[T](t: T): Future[T]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"spawn","t":"def spawn[A](op: => Future[A]): Future[A]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"tryCancel","t":"def tryCancel[A](op: Future[A]): Future[Unit]","d":"cps/monads","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"x$1","t":"val x$1: ExecutionContext","d":"cps/monads","k":"val"},
{"l":"cps/monads/fromFutureConversion.html","n":"fromFutureConversion","t":"given fromFutureConversion[G[_], T](using val x$1: ExecutionContext, val x$2: CpsAsyncMonad[G]): CpsMonadConversion[Future, G]","d":"cps/monads","k":"given"},
{"l":"cps/monads/fromFutureConversion.html","n":"apply","t":"def apply[T](ft: Future[T]): G[T]","d":"cps/monads","k":"def"},
{"l":"cps/monads/fromFutureConversion.html","n":"x$1","t":"val x$1: ExecutionContext","d":"cps/monads","k":"val"},
{"l":"cps/monads/fromFutureConversion.html","n":"x$2","t":"val x$2: CpsAsyncMonad[G]","d":"cps/monads","k":"val"},
{"l":"cps/monads/futureDiscard$.html","n":"futureDiscard","t":"given futureDiscard: WarnValueDiscard[Future]","d":"cps/monads","k":"given"},
{"l":"cps/monads/futureMemoization$.html","n":"futureMemoization","t":"given futureMemoization: Default[Future]","d":"cps/monads","k":"given"},
{"l":"cps/monads/given_CpsAwaitable_Promise$.html","n":"given_CpsAwaitable_Promise","t":"given given_CpsAwaitable_Promise: CpsAwaitable[Promise]","d":"cps/monads","k":"given"},
{"l":"cps/monads/given_CpsMonadConversion_Promise_Future$.html","n":"given_CpsMonadConversion_Promise_Future","t":"given given_CpsMonadConversion_Promise_Future: CpsMonadConversion[Promise, Future]","d":"cps/monads","k":"given"},
{"l":"cps/monads/given_CpsMonadConversion_Promise_Future$.html","n":"apply","t":"def apply[T](ft: Promise[T]): Future[T]","d":"cps/monads","k":"def"},
{"l":"cps/monads/toFutureConversion.html","n":"toFutureConversion","t":"given toFutureConversion[F[_], T](using val x$1: ExecutionContext, val x$2: CpsSchedulingMonad[F]): CpsMonadConversion[F, Future]","d":"cps/monads","k":"given"},
{"l":"cps/monads/toFutureConversion.html","n":"apply","t":"def apply[T](ft: F[T]): Future[T]","d":"cps/monads","k":"def"},
{"l":"cps/monads/toFutureConversion.html","n":"x$1","t":"val x$1: ExecutionContext","d":"cps/monads","k":"val"},
{"l":"cps/monads/toFutureConversion.html","n":"x$2","t":"val x$2: CpsSchedulingMonad[F]","d":"cps/monads","k":"val"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"FutureAsyncMonad","t":"given FutureAsyncMonad(using val x$1: ExecutionContext): CpsSchedulingMonad[Future]","d":"cps/monads/FutureAsyncMonad","k":"given"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"F","t":"type F[+T] = Future[T]","d":"cps/monads/FutureAsyncMonad","k":"type"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"WF","t":"type WF[T] = Future[T]","d":"cps/monads/FutureAsyncMonad","k":"type"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"adoptCallbackStyle","t":"def adoptCallbackStyle[A](source: Try[A] => Unit => Unit): Future[A]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"error","t":"def error[A](e: Throwable): Future[A]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"executionContext","t":"def executionContext: ExecutionContext","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"flatMap","t":"def flatMap[A, B](fa: Future[A])(f: A => Future[B]): Future[B]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"flatMapTry","t":"def flatMapTry[A, B](fa: Future[A])(f: Try[A] => Future[B]): Future[B]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"map","t":"def map[A, B](fa: Future[A])(f: A => B): Future[B]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"pure","t":"def pure[T](t: T): Future[T]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"spawn","t":"def spawn[A](op: => Future[A]): Future[A]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"tryCancel","t":"def tryCancel[A](op: Future[A]): Future[Unit]","d":"cps/monads/FutureAsyncMonad","k":"def"},
{"l":"cps/monads/FutureAsyncMonad.html","n":"x$1","t":"val x$1: ExecutionContext","d":"cps/monads/FutureAsyncMonad","k":"val"},
{"l":"cps/monads/fromFutureConversion.html","n":"fromFutureConversion","t":"given fromFutureConversion[G[_], T](using val x$1: ExecutionContext, val x$2: CpsAsyncMonad[G]): CpsMonadConversion[Future, G]","d":"cps/monads/fromFutureConversion","k":"given"},
{"l":"cps/monads/fromFutureConversion.html","n":"apply","t":"def apply[T](ft: Future[T]): G[T]","d":"cps/monads/fromFutureConversion","k":"def"},
{"l":"cps/monads/fromFutureConversion.html","n":"x$1","t":"val x$1: ExecutionContext","d":"cps/monads/fromFutureConversion","k":"val"},
{"l":"cps/monads/fromFutureConversion.html","n":"x$2","t":"val x$2: CpsAsyncMonad[G]","d":"cps/monads/fromFutureConversion","k":"val"},
{"l":"cps/monads/futureDiscard$.html","n":"futureDiscard","t":"given futureDiscard: WarnValueDiscard[Future]","d":"cps/monads/futureDiscard$","k":"given"},
{"l":"cps/monads/futureMemoization$.html","n":"futureMemoization","t":"given futureMemoization: Default[Future]","d":"cps/monads/futureMemoization$","k":"given"},
{"l":"cps/monads/given_CpsAwaitable_Promise$.html","n":"given_CpsAwaitable_Promise","t":"given given_CpsAwaitable_Promise: CpsAwaitable[Promise]","d":"cps/monads/given_CpsAwaitable_Promise$","k":"given"},
{"l":"cps/monads/given_CpsMonadConversion_Promise_Future$.html","n":"given_CpsMonadConversion_Promise_Future","t":"given given_CpsMonadConversion_Promise_Future: CpsMonadConversion[Promise, Future]","d":"cps/monads/given_CpsMonadConversion_Promise_Future$","k":"given"},
{"l":"cps/monads/given_CpsMonadConversion_Promise_Future$.html","n":"apply","t":"def apply[T](ft: Promise[T]): Future[T]","d":"cps/monads/given_CpsMonadConversion_Promise_Future$","k":"def"},
{"l":"cps/monads/toFutureConversion.html","n":"toFutureConversion","t":"given toFutureConversion[F[_], T](using val x$1: ExecutionContext, val x$2: CpsSchedulingMonad[F]): CpsMonadConversion[F, Future]","d":"cps/monads/toFutureConversion","k":"given"},
{"l":"cps/monads/toFutureConversion.html","n":"apply","t":"def apply[T](ft: F[T]): Future[T]","d":"cps/monads/toFutureConversion","k":"def"},
{"l":"cps/monads/toFutureConversion.html","n":"x$1","t":"val x$1: ExecutionContext","d":"cps/monads/toFutureConversion","k":"val"},
{"l":"cps/monads/toFutureConversion.html","n":"x$2","t":"val x$2: CpsSchedulingMonad[F]","d":"cps/monads/toFutureConversion","k":"val"},
{"l":"cps/monads/jsfuture.html","n":"cps.monads.jsfuture","t":"package cps.monads.jsfuture","d":"cps/monads/jsfuture","k":"package"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"JSFutureCpsMonad","t":"given JSFutureCpsMonad: CpsTryMonad[JSFuture]","d":"cps/monads/jsfuture","k":"given"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"error","t":"def error[A](ex: Throwable): JSFuture[A]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"flatMap","t":"def flatMap[A, B](fa: JSFuture[A])(f: A => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"flatMapTry","t":"def flatMapTry[A, B](fa: JSFuture[A])(f: Try[A] => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"map","t":"def map[A, B](fa: JSFuture[A])(f: A => B): JSFuture[B]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"pure","t":"def pure[A](a: A): JSFuture[A]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Future_JSFuture$.html","n":"given_CpsMonadConversion_Future_JSFuture","t":"given given_CpsMonadConversion_Future_JSFuture: CpsMonadConversion[Future, JSFuture]","d":"cps/monads/jsfuture","k":"given"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Future_JSFuture$.html","n":"apply","t":"def apply[T](ft: Future[T]): JSFuture[T]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_JSFuture_Future$.html","n":"given_CpsMonadConversion_JSFuture_Future","t":"given given_CpsMonadConversion_JSFuture_Future: CpsMonadConversion[JSFuture, Future]","d":"cps/monads/jsfuture","k":"given"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_JSFuture_Future$.html","n":"apply","t":"def apply[T](ft: JSFuture[T]): Future[T]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Promise_JSFuture$.html","n":"given_CpsMonadConversion_Promise_JSFuture","t":"given given_CpsMonadConversion_Promise_JSFuture: CpsMonadConversion[Promise, JSFuture]","d":"cps/monads/jsfuture","k":"given"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Promise_JSFuture$.html","n":"apply","t":"def apply[T](ft: Promise[T]): JSFuture[T]","d":"cps/monads/jsfuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"JSFuture","t":"class JSFuture[T](val executorOrUndef: UndefOr[Function2[Function1[T | Thenable[T], _], Function1[Any, _], _]], val futureOrUndef: UndefOr[Future[T]]) extends Promise[T]","d":"cps/monads/jsfuture/JSFuture","k":"class"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"executorOrUndef","t":"val executorOrUndef: UndefOr[Function2[Function1[T | Thenable[T], _], Function1[Any, _], _]]","d":"cps/monads/jsfuture/JSFuture","k":"val"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"flatMap","t":"def flatMap[S](f: T => JSFuture[S]): JSFuture[S]","d":"cps/monads/jsfuture/JSFuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"flatMapTry","t":"def flatMapTry[S](f: Try[T] => JSFuture[S]): JSFuture[S]","d":"cps/monads/jsfuture/JSFuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"future","t":"val future: Future[T]","d":"cps/monads/jsfuture/JSFuture","k":"val"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"futureOrUndef","t":"val futureOrUndef: UndefOr[Future[T]]","d":"cps/monads/jsfuture/JSFuture","k":"val"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"map","t":"def map[S](f: T => S): JSFuture[S]","d":"cps/monads/jsfuture/JSFuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFuture.html","n":"mapTry","t":"def mapTry[S](f: Try[T] => S): JSFuture[S]","d":"cps/monads/jsfuture/JSFuture","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"JSFutureCpsMonad","t":"given JSFutureCpsMonad: CpsTryMonad[JSFuture]","d":"cps/monads/jsfuture/JSFutureCpsMonad$","k":"given"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"error","t":"def error[A](ex: Throwable): JSFuture[A]","d":"cps/monads/jsfuture/JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"flatMap","t":"def flatMap[A, B](fa: JSFuture[A])(f: A => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture/JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"flatMapTry","t":"def flatMapTry[A, B](fa: JSFuture[A])(f: Try[A] => JSFuture[B]): JSFuture[B]","d":"cps/monads/jsfuture/JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"map","t":"def map[A, B](fa: JSFuture[A])(f: A => B): JSFuture[B]","d":"cps/monads/jsfuture/JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureCpsMonad$.html","n":"pure","t":"def pure[A](a: A): JSFuture[A]","d":"cps/monads/jsfuture/JSFutureCpsMonad$","k":"def"},
{"l":"cps/monads/jsfuture/JSFutureExecutor$.html","n":"JSFutureExecutor","t":"object JSFutureExecutor","d":"cps/monads/jsfuture/JSFutureExecutor$","k":"object"},
{"l":"cps/monads/jsfuture/JSFutureExecutor$.html","n":"flattenFutureComplete","t":"def flattenFutureComplete[T](future: Future[T], resolve: Function1[T, _], reject: Function1[Any, _]): Unit","d":"cps/monads/jsfuture/JSFutureExecutor$","k":"def"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Future_JSFuture$.html","n":"given_CpsMonadConversion_Future_JSFuture","t":"given given_CpsMonadConversion_Future_JSFuture: CpsMonadConversion[Future, JSFuture]","d":"cps/monads/jsfuture/given_CpsMonadConversion_Future_JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Future_JSFuture$.html","n":"apply","t":"def apply[T](ft: Future[T]): JSFuture[T]","d":"cps/monads/jsfuture/given_CpsMonadConversion_Future_JSFuture$","k":"def"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_JSFuture_Future$.html","n":"given_CpsMonadConversion_JSFuture_Future","t":"given given_CpsMonadConversion_JSFuture_Future: CpsMonadConversion[JSFuture, Future]","d":"cps/monads/jsfuture/given_CpsMonadConversion_JSFuture_Future$","k":"given"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_JSFuture_Future$.html","n":"apply","t":"def apply[T](ft: JSFuture[T]): Future[T]","d":"cps/monads/jsfuture/given_CpsMonadConversion_JSFuture_Future$","k":"def"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Promise_JSFuture$.html","n":"given_CpsMonadConversion_Promise_JSFuture","t":"given given_CpsMonadConversion_Promise_JSFuture: CpsMonadConversion[Promise, JSFuture]","d":"cps/monads/jsfuture/given_CpsMonadConversion_Promise_JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/given_CpsMonadConversion_Promise_JSFuture$.html","n":"apply","t":"def apply[T](ft: Promise[T]): JSFuture[T]","d":"cps/monads/jsfuture/given_CpsMonadConversion_Promise_JSFuture$","k":"def"},
...
{"l":"cps/runtime/util/TryModuleAsyncShift$.html","n":"TryModuleAsyncShift","t":"object TryModuleAsyncShift extends AsyncShift[Try]","d":"cps/runtime/util/TryModuleAsyncShift$","k":"object"},
{"l":"cps/runtime/util/TryModuleAsyncShift$.html","n":"apply","t":"def apply[F[_], T](o: Try, m: CpsTryMonad[F])(r: () => F[T]): F[Try[T]]","d":"cps/runtime/util/TryModuleAsyncShift$","k":"def"},
{"l":"cps/runtime/util/UsingAsyncShift$.html","n":"UsingAsyncShift","t":"object UsingAsyncShift extends AsyncShift[Using]","d":"cps/runtime/util/UsingAsyncShift$","k":"object"},
{"l":"cps/runtime/util/UsingAsyncShift$.html","n":"apply","t":"def apply[F[_], R, A](o: Using, m: CpsTryMonad[F])(resource: () => F[R])(f: R => F[A])(implicit arg0: Releasable[R]): F[Try[A]]","d":"cps/runtime/util/UsingAsyncShift$","k":"def"},
{"l":"cps/runtime/util/UsingAsyncShift$.html","n":"resource","t":"def resource[F[_], R, A](o: Using, m: CpsTryMonad[F])(r: R)(f: R => F[A])(implicit arg0: Releasable[R]): F[A]","d":"cps/runtime/util/UsingAsyncShift$","k":"def"},
{"l":"cps/runtime/util/UsingAsyncShift$.html","n":"resources","t":"def resources[F[_], R1, R2, A](o: Using, m: CpsTryMonad[F])(r1: R1, r2: () => F[R2])(f: (R1, R2) => F[A])(implicit r1Releasable: Releasable[R1], r2Releasable: Releasable[R2]): F[A]","d":"cps/runtime/util/UsingAsyncShift$","k":"def"},
{"l":"cps/runtime/util/UsingAsyncShift$.html","n":"resources","t":"def resources[F[_], R1, R2, R3, A](o: Using, m: CpsTryMonad[F])(r1: R1, r2: () => F[R2], r3: () => F[R3])(f: (R1, R2, R3) => F[A])(implicit r1Releasable: Releasable[R1], r2Releasable: Releasable[R2], r3Releasable: Releasable[R3]): F[A]","d":"cps/runtime/util/UsingAsyncShift$","k":"def"},
{"l":"cps/runtime/util/UsingAsyncShift$.html","n":"resources","t":"def resources[F[_], R1, R2, R3, R4, A](o: Using, m: CpsTryMonad[F])(r1: R1, r2: () => F[R2], r3: () => F[R3], r4: () => F[R4])(f: (R1, R2, R3, R4) => F[A])(implicit r1Rl: Releasable[R1], r2Rl: Releasable[R2], r3Rl: Releasable[R3], r4Rl: Releasable[R4]): F[A]","d":"cps/runtime/util/UsingAsyncShift$","k":"def"},
...
{"l":"cps/stream/AsyncIterator$.html","n":"absorber","t":"given absorber: CpsAsyncEmitAbsorber[R]","d":"cps/stream/AsyncIterator$","k":"given"},
...
{"l":"cps/stream/AsyncIteratorEmitAbsorber.html","n":"AsyncIteratorEmitAbsorber","t":"class AsyncIteratorEmitAbsorber[F[_], T](implicit evidence$3: CpsConcurrentMonad[F], x$1: ExecutionContext) extends BaseUnfoldCpsAsyncEmitAbsorber[AsyncIterator[F, T], F, T]","d":"cps/stream/AsyncIteratorEmitAbsorber","k":"class"},
{"l":"cps/stream/AsyncIteratorEmitAbsorber.html","n":"Element","t":"type Element = T","d":"cps/stream/AsyncIteratorEmitAbsorber","k":"type"},
{"l":"cps/stream/AsyncIteratorEmitAbsorber.html","n":"unfold","t":"def unfold[S](s0: S)(f: S => F[Option[(T, S)]]): AsyncIterator[F, T]","d":"cps/stream/AsyncIteratorEmitAbsorber","k":"def"},
...
{"l":"cps/stream/AsyncList$.html","n":"absorber","t":"given absorber: CpsAsyncEmitAbsorber[R]","d":"cps/stream/AsyncList$","k":"given"},
...
{"l":"cps/stream/AsyncList$$Cons.html","n":"Cons","t":"class Cons[F[_], T](head: T, tailFun: () => AsyncList[F, T])(implicit evidence$4: CpsConcurrentMonad[F]) extends AsyncList[F, T]","d":"cps/stream/AsyncList$$Cons","k":"class"},
...
{"l":"cps/stream/AsyncList$$Empty.html","n":"Empty","t":"class Empty[F[_]]()(implicit evidence$5: CpsConcurrentMonad[F]) extends AsyncList[F, Nothing]","d":"cps/stream/AsyncList$$Empty","k":"class"},
...
{"l":"cps/stream/AsyncList$$Wait.html","n":"Wait","t":"class Wait[F[_], T](fs: F[AsyncList[F, T]])(implicit evidence$3: CpsConcurrentMonad[F]) extends AsyncList[F, T]","d":"cps/stream/AsyncList$$Wait","k":"class"},
...
{"l":"cps/stream/AsyncListEmitAbsorber.html","n":"AsyncListEmitAbsorber","t":"class AsyncListEmitAbsorber[F[_], T](implicit evidence$2: CpsConcurrentMonad[F], ec: ExecutionContext) extends BaseUnfoldCpsAsyncEmitAbsorber[AsyncList[F, T], F, T]","d":"cps/stream/AsyncListEmitAbsorber","k":"class"},
...
{"l":"cps/stream/AsyncListIterator.html","n":"AsyncListIterator","t":"class AsyncListIterator[F[_], T](l: AsyncList[F, T])(implicit evidence$2: CpsConcurrentMonad[F]) extends AsyncIterator[F, T]","d":"cps/stream/AsyncListIterator","k":"class"},
...
{"l":"cps/stream/AsyncStreamHelper.html","n":"AsyncStreamHelper","t":"class AsyncStreamHelper[R, F[_], A](a: Aux[R, F, A])","d":"cps/stream/AsyncStreamHelper","k":"class"},
{"l":"cps/stream/AsyncStreamHelper.html","n":"apply","t":"def apply(inline f: CpsAsyncEmitter[R, F, A] => Unit): R","d":"cps/stream/AsyncStreamHelper","k":"def"},
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"BaseUnfoldCpsAsyncEmitAbsorber","t":"trait BaseUnfoldCpsAsyncEmitAbsorber[R, F[_], T](implicit evidence$1: CpsConcurrentMonad[F], x$1: ExecutionContext) extends CpsAsyncEmitAbsorber3[R, F, T]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"trait"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"asyncMonad","t":"val asyncMonad: CpsConcurrentMonad[F]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"val"},
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"evalAsync","t":"def evalAsync(f: CpsAsyncEmitter[R, F, T] => F[Unit]): R","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"def"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"unitSuccess","t":"val unitSuccess: Success[Unit]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"val"},
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$Emitted.html","n":"Emitted","t":"class Emitted(value: T, emitCallback: Try[Unit] => Unit) extends SupplyEventRecord","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$Emitted","k":"class"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$State.html","n":"consumerEvents","t":"val consumerEvents: Queue[ConsumerCallback]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$State","k":"val"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$State.html","n":"finishRef","t":"val finishRef: AtomicReference[Try[Unit]]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$State","k":"val"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$State.html","n":"supplyEvents","t":"val supplyEvents: Queue[SupplyEventRecord]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$State","k":"val"},
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$StepsObserver.html","n":"StepsObserver","t":"class StepsObserver(state: State) extends CpsAsyncEmitter[R, F, T]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber$StepsObserver","k":"class"},
...
{"l":"cps/stream/CpsAsyncEmitAbsorber.html","n":"asyncMonad","t":"def asyncMonad: CpsAsyncMonad[Monad]","d":"cps/stream/CpsAsyncEmitAbsorber","k":"def"},
{"l":"cps/stream/CpsAsyncEmitAbsorber.html","n":"evalAsync","t":"def evalAsync(f: CpsAsyncEmitter[R, Monad, Element] => Monad[Unit]): R","d":"cps/stream/CpsAsyncEmitAbsorber","k":"def"},
...
{"l":"cps/stream/CpsAsyncEmitAbsorber$.html","n":"Aux","t":"type Aux[R, F[_], T] = CpsAsyncEmitAbsorber[R] { type Monad = F; type Element = T;  }","d":"cps/stream/CpsAsyncEmitAbsorber$","k":"type"},
{"l":"cps/stream/CpsAsyncEmitAbsorber3.html","n":"CpsAsyncEmitAbsorber3","t":"trait CpsAsyncEmitAbsorber3[R, F[_], T] extends CpsAsyncEmitAbsorber[R]","d":"cps/stream/CpsAsyncEmitAbsorber3","k":"trait"},
{"l":"cps/stream/CpsAsyncEmitAbsorber3.html","n":"Element","t":"type Element = T","d":"cps/stream/CpsAsyncEmitAbsorber3","k":"type"},
{"l":"cps/stream/CpsAsyncEmitAbsorber3.html","n":"Monad","t":"type Monad[X] = F[X]","d":"cps/stream/CpsAsyncEmitAbsorber3","k":"type"},
{"l":"cps/stream/CpsAsyncEmitter.html","n":"CpsAsyncEmitter","t":"trait CpsAsyncEmitter[R, F[_], E]","d":"cps/stream/CpsAsyncEmitter","k":"trait"},
{"l":"cps/stream/CpsAsyncEmitter.html","n":"emit","t":"def emit(v: E): Unit","d":"cps/stream/CpsAsyncEmitter","k":"def"},
...
{"l":"cps/stream/CpsAsyncStreamMacro$.html","n":"transform","t":"def transform[R : Type, F[_] : Type, T : Type](f: Expr[CpsAsyncEmitter[R, F, T] => Unit], absorber: Expr[Aux[R, F, T]])(implicit evidence$3: Type[R], evidence$4: Type[F], evidence$5: Type[T], Quotes): Expr[R]","d":"cps/stream/CpsAsyncStreamMacro$","k":"def"},
{"l":"cps/stream/CpsAsyncStreamMacro$.html","n":"transformTree","t":"def transformTree[R : Type, F[_] : Type, T : Type](using qctx: Quotes)(f: Term, absorber: Expr[Aux[R, F, T]]): Term","d":"cps/stream/CpsAsyncStreamMacro$","k":"def"},
...
{"l":"cps/syntax.html","n":"unary_!","t":"def unary_!(using CpsAwaitable[F]): T","d":"cps/syntax","k":"def"},
