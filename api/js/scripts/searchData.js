...
{"l":"cps/CpsMonadInstanceContext.html","n":"CpsMonadInstanceContext","t":"trait CpsMonadInstanceContext[F[_]] extends CpsMonad[F]","d":"cps/CpsMonadInstanceContext","k":"trait"},
{"l":"cps/CpsMonadInstanceContext.html","n":"Context","t":"type Context = CpsMonadInstanceContextBody[F]","d":"cps/CpsMonadInstanceContext","k":"type"},
...
{"l":"cps/CpsMonadInstanceContextBody.html","n":"CpsMonadInstanceContextBody","t":"class CpsMonadInstanceContextBody[F[_]](m: CpsMonadInstanceContext[F]) extends CpsMonadContext[F]","d":"cps/CpsMonadInstanceContextBody","k":"class"},
{"l":"cps/CpsMonadInstanceContextBody.html","n":"adoptAwait","t":"def adoptAwait[A](fa: F[A]): F[A]","d":"cps/CpsMonadInstanceContextBody","k":"def"},
{"l":"cps/CpsMonadInstanceContextBody.html","n":"monad","t":"def monad: CpsMonad[F]","d":"cps/CpsMonadInstanceContextBody","k":"def"},
...
{"l":"cps/CpsSchedulingMonad$.html","n":"CpsSchedulingMonad","t":"object CpsSchedulingMonad","d":"cps/CpsSchedulingMonad$","k":"object"},
{"l":"cps/CpsSchedulingMonad$.html","n":"Aux","t":"type Aux[F[_], C <: CpsMonadContext[F]] = CpsSchedulingMonad[F] { type Context = C;  }","d":"cps/CpsSchedulingMonad$","k":"type"},
...
{"l":"cps/macros/forest/BlockTreeTransform.html","n":"BlockTreeTransform","t":"trait BlockTreeTransform[F[_], CT, CC <: CpsMonadContext[F]]","d":"cps/macros/forest/BlockTreeTransform","k":"trait"},
{"l":"cps/macros/forest/BlockTreeTransform.html","n":"blockApplyValueDiscard","t":"def blockApplyValueDiscard(t: <none>): <none>","d":"cps/macros/forest/BlockTreeTransform","k":"def"},
{"l":"cps/macros/forest/BlockTreeTransform.html","n":"blockBuildAwaitValueDiscard","t":"def blockBuildAwaitValueDiscard(discardTerm: <none>, p: <none>): <none>","d":"cps/macros/forest/BlockTreeTransform","k":"def"},
{"l":"cps/macros/forest/BlockTreeTransform.html","n":"blockCheckValueDiscarded","t":"def blockCheckValueDiscarded(t: <none>): Boolean","d":"cps/macros/forest/BlockTreeTransform","k":"def"},
{"l":"cps/macros/forest/BlockTreeTransform.html","n":"runBlock","t":"def runBlock(block: <none>, prevs: List[<none>], last: <none>): <none>","d":"cps/macros/forest/BlockTreeTransform","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope.html","n":"adoptStatement","t":"def adoptStatement(t: Statement): Statement","d":"cps/macros/forest/CpsTreeScope","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$CpsTree$.html","n":"empty","t":"def empty: CpsTree","d":"cps/macros/forest/CpsTreeScope$CpsTree$","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"EmptyCpsTree","t":"object EmptyCpsTree extends CpsTree","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"object"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"appendFinal","t":"def appendFinal(next: CpsTree): CpsTree","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"applyAwait","t":"def applyAwait(newOtpe: TypeRepr): CpsTree","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"castOtpe","t":"def castOtpe(newOtpe: TypeRepr): CpsTree","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"inCake","t":"def inCake[F1[_], T1, C1 <: CpsMonadContext[F1]](otherCake: TreeTransformScope[F1, T1, C1]): EmptyCpsTree.type","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"isAsync","t":"def isAsync: Boolean","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"isChanged","t":"def isChanged: Boolean","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"isLambda","t":"def isLambda: Boolean","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"monadFlatMap","t":"def monadFlatMap(f: Term => Term, ntpe: TypeRepr): CpsTree","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"monadMap","t":"def monadMap(f: Term => Term, ntpe: TypeRepr): CpsTree","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"otpe","t":"def otpe: TypeRepr","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"syncOrigin","t":"def syncOrigin: Option[Term]","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
{"l":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$.html","n":"transformed","t":"def transformed: Term","d":"cps/macros/forest/CpsTreeScope$EmptyCpsTree$","k":"def"},
...
{"l":"cps/macros/forest/CpsTreeScope$PureCpsTree.html","n":"PureCpsTree","t":"class PureCpsTree(origin: Statement, isChanged: Boolean) extends CpsTree","d":"cps/macros/forest/CpsTreeScope$PureCpsTree","k":"class"},
...
{"l":"cps/macros/forest/InlinedTreeTransform.html","n":"generateAwaitFor","t":"def generateAwaitFor(term: <none>, tpe: <none>): <none>","d":"cps/macros/forest/InlinedTreeTransform","k":"def"},
...
{"l":"cps/macros/forest/TreeTransformScope.html","n":"TreeTransformScope","t":"trait TreeTransformScope[F[_], CT, CC <: CpsMonadContext[F]] extends CpsTreeScope[F, CT, CC] with KnownTreeFragments[F, CT, CC] with TypeApplyTreeTransform[F, CT, CC] with RootTreeTransform[F, CT, CC] with ApplyTreeTransform[F, CT, CC] with ApplicationHelper[F, CT, CC] with AwaitTreeTransform[F, CT, CC] with SelectTreeTransform[F, CT, CC] with LambdaTreeTransform[F, CT, CC] with MatchTreeTransform[F, CT, CC] with AsyncTreeShifter[F, CT, CC] with RepeatedTreeTransform[F, CT, CC] with InlinedTreeTransform[F, CT, CC] with SelectOuterTreeTransform[F, CT, CC] with BlockTreeTransform[F, CT, CC] with ValDefTreeTransform[F, CT, CC]","d":"cps/macros/forest/TreeTransformScope","k":"trait"},
...
{"l":"cps/macros/forest/TreeTransformScope.html","n":"safeShow","t":"def safeShow(t: Tree): String","d":"cps/macros/forest/TreeTransformScope","k":"def"},
{"l":"cps/macros/forest/TreeTransformScope.html","n":"safeTypeShow","t":"def safeTypeShow(tp: TypeRepr): String","d":"cps/macros/forest/TreeTransformScope","k":"def"},
{"l":"cps/macros/forest/TreeTransformScope.html","n":"unitTerm","t":"def unitTerm: Literal","d":"cps/macros/forest/TreeTransformScope","k":"def"},
...
{"l":"cps/macros/forest/ValDefTreeTransform.html","n":"ValDefTreeTransform","t":"trait ValDefTreeTransform[F[_], CT, CC <: CpsMonadContext[F]]","d":"cps/macros/forest/ValDefTreeTransform","k":"trait"},
{"l":"cps/macros/forest/ValDefTreeTransform.html","n":"runValDefFromBlock","t":"def runValDefFromBlock(block: <none>, valDef: <none>): <none>","d":"cps/macros/forest/ValDefTreeTransform","k":"def"},
{"l":"cps/macros/forest/ValDefTreeTransform.html","n":"valDefApplyMemoization","t":"def valDefApplyMemoization(valDef: <none>, cpsRhs: <none>, rhs: <none>): <none>","d":"cps/macros/forest/ValDefTreeTransform","k":"def"},
...
{"l":"cps/monads.html","n":"FreeCpsMonad","t":"given FreeCpsMonad: FreeCpsMonad.type","d":"cps/monads","k":"given"},
...
{"l":"cps/monads.html","n":"given_CpsAwaitable_Promise","t":"given given_CpsAwaitable_Promise: given_CpsAwaitable_Promise.type","d":"cps/monads","k":"given"},
{"l":"cps/monads.html","n":"given_CpsMonadConversion_Promise_Future","t":"given given_CpsMonadConversion_Promise_Future: given_CpsMonadConversion_Promise_Future.type","d":"cps/monads","k":"given"},
{"l":"cps/monads.html","n":"given_CpsMonadMemoization_Promise","t":"given given_CpsMonadMemoization_Promise: CpsMonadMemoization[Promise]","d":"cps/monads","k":"given"},
...
{"l":"cps/monads/FreeCpsMonad$.html","n":"FreeCpsMonad","t":"object FreeCpsMonad extends CpsTryMonad[FreeMonad] with CpsMonadInstanceContext[FreeMonad]","d":"cps/monads/FreeCpsMonad$","k":"object"},
{"l":"cps/monads/FreeCpsMonad$.html","n":"F","t":"type F[A] = FreeMonad[A]","d":"cps/monads/FreeCpsMonad$","k":"type"},
{"l":"cps/monads/FreeCpsMonad$.html","n":"adoptCallbackStyle","t":"def adoptCallbackStyle[A](source: Try[A] => Unit => Unit): FreeMonad[A]","d":"cps/monads/FreeCpsMonad$","k":"def"},
{"l":"cps/monads/FreeCpsMonad$.html","n":"error","t":"def error[A](e: Throwable): FreeMonad[A]","d":"cps/monads/FreeCpsMonad$","k":"def"},
{"l":"cps/monads/FreeCpsMonad$.html","n":"flatMap","t":"def flatMap[A, B](fa: FreeMonad[A])(f: A => FreeMonad[B]): FreeMonad[B]","d":"cps/monads/FreeCpsMonad$","k":"def"},
{"l":"cps/monads/FreeCpsMonad$.html","n":"flatMapTry","t":"def flatMapTry[A, B](fa: FreeMonad[A])(f: Try[A] => FreeMonad[B]): FreeMonad[B]","d":"cps/monads/FreeCpsMonad$","k":"def"},
{"l":"cps/monads/FreeCpsMonad$.html","n":"map","t":"def map[A, B](fa: FreeMonad[A])(f: A => B): FreeMonad[B]","d":"cps/monads/FreeCpsMonad$","k":"def"},
{"l":"cps/monads/FreeCpsMonad$.html","n":"pure","t":"def pure[A](a: A): FreeMonad[A]","d":"cps/monads/FreeCpsMonad$","k":"def"},
{"l":"cps/monads/FreeMonad.html","n":"FreeMonad","t":"trait FreeMonad[+T]","d":"cps/monads/FreeMonad","k":"trait"},
{"l":"cps/monads/FreeMonad$.html","n":"FreeMonad","t":"object FreeMonad","d":"cps/monads/FreeMonad$","k":"object"},
{"l":"cps/monads/FreeMonad$$AdoptCallbackStyle.html","n":"AdoptCallbackStyle","t":"class AdoptCallbackStyle[A](source: Try[A] => Unit => Unit) extends FreeMonad[A]","d":"cps/monads/FreeMonad$$AdoptCallbackStyle","k":"class"},
{"l":"cps/monads/FreeMonad$$Error.html","n":"Error","t":"class Error(e: Throwable) extends FreeMonad[Nothing]","d":"cps/monads/FreeMonad$$Error","k":"class"},
{"l":"cps/monads/FreeMonad$$FlatMap.html","n":"FlatMap","t":"class FlatMap[A, B](fa: FreeMonad[A], f: A => FreeMonad[B]) extends FreeMonad[B]","d":"cps/monads/FreeMonad$$FlatMap","k":"class"},
{"l":"cps/monads/FreeMonad$$FlatMapTry.html","n":"FlatMapTry","t":"class FlatMapTry[A, B](fa: FreeMonad[A], f: Try[A] => FreeMonad[B]) extends FreeMonad[B]","d":"cps/monads/FreeMonad$$FlatMapTry","k":"class"},
{"l":"cps/monads/FreeMonad$$Map.html","n":"Map","t":"class Map[A, B](fa: FreeMonad[A], f: A => B) extends FreeMonad[B]","d":"cps/monads/FreeMonad$$Map","k":"class"},
{"l":"cps/monads/FreeMonad$$Pure.html","n":"Pure","t":"class Pure[A](a: A) extends FreeMonad[A]","d":"cps/monads/FreeMonad$$Pure","k":"class"},
...
{"l":"cps/monads/given_CpsAwaitable_Promise$.html","n":"given_CpsAwaitable_Promise","t":"object given_CpsAwaitable_Promise extends CpsAwaitable[Promise]","d":"cps/monads/given_CpsAwaitable_Promise$","k":"object"},
{"l":"cps/monads/given_CpsMonadConversion_Promise_Future$.html","n":"given_CpsMonadConversion_Promise_Future","t":"object given_CpsMonadConversion_Promise_Future extends CpsMonadConversion[Promise, Future]","d":"cps/monads/given_CpsMonadConversion_Promise_Future$","k":"object"},
...
{"l":"cps/monads/jsfuture/JSFuture$.html","n":"JSFutureCpsMonad","t":"given JSFutureCpsMonad: JSFutureCpsMonad.type","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$.html","n":"given_CpsMonadConversion_Future_JSFuture","t":"given given_CpsMonadConversion_Future_JSFuture: given_CpsMonadConversion_Future_JSFuture.type","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$.html","n":"given_CpsMonadConversion_JSFuture_Future","t":"given given_CpsMonadConversion_JSFuture_Future: given_CpsMonadConversion_JSFuture_Future.type","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$.html","n":"given_CpsMonadConversion_Promise_JSFuture","t":"given given_CpsMonadConversion_Promise_JSFuture: given_CpsMonadConversion_Promise_JSFuture.type","d":"cps/monads/jsfuture/JSFuture$","k":"given"},
{"l":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$.html","n":"JSFutureCpsMonad","t":"object JSFutureCpsMonad extends CpsTryMonad[JSFuture] with CpsMonadInstanceContext[JSFuture]","d":"cps/monads/jsfuture/JSFuture$$JSFutureCpsMonad$","k":"object"},
...
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$.html","n":"given_CpsMonadConversion_Future_JSFuture","t":"object given_CpsMonadConversion_Future_JSFuture extends CpsMonadConversion[Future, JSFuture]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Future_JSFuture$","k":"object"},
...
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$.html","n":"given_CpsMonadConversion_JSFuture_Future","t":"object given_CpsMonadConversion_JSFuture_Future extends CpsMonadConversion[JSFuture, Future]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_JSFuture_Future$","k":"object"},
...
{"l":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$.html","n":"given_CpsMonadConversion_Promise_JSFuture","t":"object given_CpsMonadConversion_Promise_JSFuture extends CpsMonadConversion[Promise, JSFuture]","d":"cps/monads/jsfuture/JSFuture$$given_CpsMonadConversion_Promise_JSFuture$","k":"object"},
...
{"l":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber.html","n":"BaseUnfoldCpsAsyncEmitAbsorber","t":"trait BaseUnfoldCpsAsyncEmitAbsorber[R, F[_], C <: CpsMonadContext[F], T](using ec: ExecutionContext, auxAsyncMonad: Aux[F, C]) extends CpsAsyncEmitAbsorber4[R, F, C, T]","d":"cps/stream/BaseUnfoldCpsAsyncEmitAbsorber","k":"trait"},
