...
extension [A](fa: Future[A])
  ...
  /** Create a future which will return true or false <code> fa </code> has no completed duriong <code> duration </code>
    */
  ...
  /** Create a future which will return or value of original future <code> fa </code> or raise a timeout exception, if <code> fa
    * </code> has no completed duriong <code> duration </code>
    */
...
/** Timed await -- await for future or throw TimeoutException after <code> duration </code>
  */
transparent inline def timedAwait[A](fa: Future[A], duration: FiniteDuration)(using
    CpsMonadContext[Future],
...
transparent inline def timedReady[A](fa: Future[A], duration: FiniteDuration)(using
    CpsMonadContext[Future],
    ExecutionContextProvider,
    ScheduledExecutorService
): Boolean =
