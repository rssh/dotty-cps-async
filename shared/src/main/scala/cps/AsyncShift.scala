...
trait AsyncShiftLowPriority2 extends AsyncShiftLowPriority1 {
  ...
  transparent inline given shiftedMapOps[K, V, CC[K, V] <: MapOps[K, V, CC, CC[K, V]] & Iterable[(K, V)]]
...
object AsyncShift extends AsyncShiftLowPriority3 {
  ...
  transparent inline given shiftedImmutableMapOps[K, V, CC[K, V] <: MapOps[K, V, CC, CC[K, V]] & immutable.Iterable[(K, V)]]
