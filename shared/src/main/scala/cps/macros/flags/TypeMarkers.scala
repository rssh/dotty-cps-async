...
/** if implicit object is defined, than macro use runtime await for CpsRuntimeAwait (work only on JVM with JDK-19 early access,
  * which inclipe project loom support)
  */
class UseLoomAwait
