...
class Function1AndThenCallChainSubst[F[_], A, B, C](f: A => B, g: B => F[C], m: CpsMonad[F])
    extends CallChainAsyncShiftSubst[F, A => C, A => F[C]]:
...
class Function1ComposeCallChainSubst[F[_], A, B, Z](f: A => B, g: Z => F[A], m: CpsMonad[F])
    extends CallChainAsyncShiftSubst[F, Z => B, Z => F[B]]:
...
class Function1ComposeAndThenCallChainSubst[F[_], A, B, C](f: A => F[B], g: B => F[C], m: CpsMonad[F])
    extends CallChainAsyncShiftSubst[F, A => C, A => F[C]]:
