...
class MapOpsAsyncShift[K, V, CC[KX, VX] <: MapOps[KX, VX, CC, CC[KX, VX]] & CI[(KX, VX)], CI[X] <: Iterable[
  X
] & IterableOps[X, CI, CI[X]], CKV <: CC[K, V] & PartialFunction[K, V]]
    extends IterableOpsAsyncShift[(K, V), CI, CKV]
